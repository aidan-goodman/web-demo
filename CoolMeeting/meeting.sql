CREATE DATABASE IF NOT EXISTS `meeting` DEFAULT CHARACTER SET utf8;
...
insert into `counter`(`visitcount`, `id`)
values (105, 1);
...
values (8, '王晓华', 'wangxh', '13671075406', 'wang@qq.com', '1', 13, '1', '1'),
       ...
       (23, '陈晨', 'wangm', '22·2', '11', '1', 14, '1', '2'),
       (25, '王晓华', 'wangxh222', '111', '1', '1', 14, '1', '2'),
       (27, '张三', 'zhangsan', '122', '22', '1', 16, '1', '2'),
       (28, '李四', 'lisi', '1', '1', '1', 16, '1', '2'),
       (29, '王五', 'wangwu', '1', '1', '1', 17, '1', '2'),
       (30, '赵六', 'zhaoliu', '1', '1', '1', 13, '1', '2'),
       (32, '冯七', 'fengqi', '1', '1', '1', 13, '1', '2'),
       (33, '马八', 'maba', '1', '1', '1', 13, '1', '2'),
       (34, '钱十', 'qianshi', '1', '1', '2', 13, '1', '2'),
       (35, '周十一', 'zhoushiyi', '1', '1', '1', 13, '1', '2'),
...
insert into `meeting`(`meetingid`, `meetingname`, `roomid`, `reservationistid`, `numberofparticipants`, `starttime`,
                      `endtime`, `reservationtime`, `canceledtime`, `description`, `status`, `canceledreason`)
values (25, 'ces', 5, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-10 23:02:39', '2017-08-23 14:48:40',
       ...
       (26, '测测', 7, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-17 23:04:18', '2015-01-11 01:06:20',
        NULL, '0', NULL),
       (27, '我看看', 6, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-10 23:06:33', '2015-01-11 01:01:42',
        '我看看', '0', NULL),
       (28, '运营会', 5, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-10 23:26:26', '2017-08-23 14:49:06',
        '测试', '0', 'ppppppppppppppppppppp'),
       (29, '市场部会议', 6, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-10 23:44:41', NULL, '市场部', '0',
        NULL),
       (30, '内部会议', 10, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-10 23:56:20', NULL, '内部会议', '0',
        NULL),
       (31, '我的会议', 9, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-11 16:35:11', NULL, '测试', '0',
        NULL),
       (32, '我的会议哈哈', 5, 8, 10, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-11 16:40:50', NULL, '', '0',
        NULL),
       (33, '哈哈', 6, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-11 16:42:09', '2015-01-12 11:44:57',
        '你好', '0', NULL),
       (34, '我的会议3', 8, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-11 16:42:51', NULL, '测试', '0',
        NULL),
       ...
       (36, '我问问', 7, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-11 16:57:56', '2015-01-11 16:59:57',
        '地点', '0', NULL),
       (37, '我的会议4', 7, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-11 16:59:49', NULL, '我的会议', '0',
        NULL),
       (38, '班会', 9, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-12 11:49:17', '2015-01-12 11:49:37',
        '班会', '1', NULL),
       (39, '测试会议', 5, 8, 12, '2017-08-25 12:00:00', '2017-08-30 12:00:00', '2015-01-14 14:44:07', NULL, 'ss', '0',
        NULL),
...
values (5, 101, '第一会议室', 15, '0', '公共会议室'),
       ...
       (15, 999, '第999会议室', 99, '0', '第999会议室，哈哈哈哈哈'),
